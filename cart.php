...
<div class="col-md-12">
	<div class="row">
		...
		<?php if ($cart_id == ''): ?>
			<div class="bg-danger">
				<p class="text-center text-danger">Your shopping cart is empty! <a href="index.php"> Go back shopping.</a></p>
			</div>
		<?php else: ?>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="row">
				       <form action="thankYou.php" method="POST" id="payment-form">
				       		...
				       		<input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count > 1)?'s':'').' from our shop.';?>">
...
function back_address () {
	...
	// 		// Disable the submit button to prevent repeate clicks.
